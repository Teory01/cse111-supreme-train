def main():
    ...
    if vin in vehicles_dict:
        # Extract the data for the vehicle from the vehicles dictionary.
        cars_info = vehicles_dict[vin]

        # Find the data for the vehicle that the user wants.
        # Print the manufacturer, model, and color of the vehicle.
        
        Manufacturer = cars_info[MANUFACTURER_INDEX]
        Model = cars_info[MODEL_INDEX]
        Color = cars_info[COLOR_INDEX]

        #print the output in the stated format 
